    ...
    <div class="anketa">
        <form class="anketaForm" method="POST" action="{{ route('vietos.reserveSeat') }}" >
            ...
            <div class="innerAnketa">
                ...
                <input class="formText" type="text" name="name" required minlength="4" autocomplete="off">
                <h3 class="formText">Pavarde</h3>
                <input class="formText" type="text"name="lName" required minlength="4" autocomplete="off"><br><br>
